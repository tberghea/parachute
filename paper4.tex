...
In addition to the PS1 data, we have also looked for archival data of this system. The system is detected in the Gaia \citep{gaia} catalogues where, similar the the PS1 catalogues, only A and D are deblended by the automatic pipeline. We use the Gaia position for component D as absolute astrometric reference position for this system: 26.792307, 46.511273. The errors for these coordinates are 15.6 and 8.9 mas, respectively [NEEDS REFERENCE].
